...
COMMANDS: list[ReproCommand] = [
    ...
    ReproCommand("gradcam summary","python -m terrasight.reporting.generate_gradcam_summary --input-dir reports/figures/gradcam --output reports/figures/gradcam/gradcam_summary.png --max-images 6 --columns 1", requires_existing_inputs=True,allow_placeholders=True),
