...
configs/v1\_rgb\_baseline.yaml

configs/v1\_rgb\_scratch.yaml

configs/v1\_multispectral\_scratch.yaml

configs/v1\_multispectral\_pretrained\_adapted.yaml

configs/v4\_ablation\_rgb\_rededge\_nir\_swir.yaml
...
python -m terrasight.data.split \\

&#x20; --config configs/v1\_rgb\_baseline.yaml
...
python -m terrasight.pipelines.train\_rgb \\
...
python -m terrasight.pipelines.train\_multispectral \\

&#x20; --config configs/v1\_multispectral\_pretrained\_adapted.yaml
...
&#x20; --config configs/v4\_ablation\_rgb\_rededge\_nir\_swir.yaml
